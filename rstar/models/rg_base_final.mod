...
estimation(order=1,optim=('MaxIter',1000,'Tolfun',1.0e-06),datafile='../data/observables.csv',mode_compute=5,mode_file=rg_base_final_mode,first_obs=5,presample=4,lik_init=2,prefilter=1,mh_replic=0,mh_nblocks=2,mh_jscale=0.35,mh_drop=0.2,filtered_vars,smoothed_state_uncertainty,nograph) yU uU tr tg;
