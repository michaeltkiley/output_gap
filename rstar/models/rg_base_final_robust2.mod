...
stderr e_t4, .1, 0.0001, 1000,INV_GAMMA_PDF,.5,.5;
stderr e_yu, .5, 0.0001, 1000,INV_GAMMA_PDF,2,2;
stderr e_tr, .1, 0.0001, 1000,INV_GAMMA_PDF,.5,.5;
stderr eg, .1, 0.0001, 1000,INV_GAMMA_PDF,.5,.5;
...
estimation(tex,order=1,optim=('MaxIter',1000,'Tolfun',1.0e-06),datafile='rstardata',mode_compute=5,first_obs=5,presample=4,lik_init=2,prefilter=1,mh_replic=500000,mh_nblocks=2,mh_jscale=0.5,mh_drop=0.2,filtered_vars,smoothed_state_uncertainty) uU tr tg;
