...
// Kalman-smooth the observed data at the fixed (posterior-mode) parameter
// values above -- no re-estimation. datafile columns must be named to
// match the varobs list; see scripts/build_observables.py.
calib_smoother(datafile='../data/observables_replication.csv') GAP PFGAP;
